...
export default function BlogVideoManager({ mode = "blog" }: { mode?: "blog" | "video" }) {
  ...
  return <DashboardLayout><div className={`mx-auto pb-20 ${isPreviewOpen && previewPath ? "max-w-[1720px] lg:grid lg:grid-cols-[minmax(0,1fr)_minmax(360px,470px)] lg:gap-6" : "max-w-6xl"}`}><main>
